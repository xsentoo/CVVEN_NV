...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex">
                <a href="http://localhost/CVVEN/auth/login">
                <button type="button" class="btn btn-outline-dark shadow-none me-lg-3 me-2"  data-bs-target="#loginModal">
                    Login
                </button>
                </a>
        ...
        <div class="swiper swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="<?= base_url('public/carousel/room1.png') ?>" class="w-100 d-block" />
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo base_url('public/carousel/room2.png'); ?>" class="w-100 d-block" />
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo base_url('public/carousel/room3.png'); ?>" class="w-100 d-block" />
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo base_url('public/carousel/room4.png'); ?>" class="w-100 d-block" />
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo base_url('public/carousel/room5.png'); ?>" class="w-100 d-block" />
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo base_url('public/carousel/room6.png'); ?>" class="w-100 d-block" />
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow" style="max-width: 350px; margin:auto ;">
                    <img src="<?php echo base_url('public/rooms/1.jpg'); ?>" class="card-img-top" >
                    <div class="card-body">
                        <h5>Simple Room</h5>
            ...
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow" style="max-width: 350px; margin:auto ;">
                    <img src="<?php echo base_url('public/rooms/IMG_11892.png'); ?>" class="card-img-top" >
                    <div class="card-body">
                        <h5>Simple Room</h5>
            ...
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow" style="max-width: 350px; margin:auto ;">
                    <img src="<?php echo base_url('public/rooms/IMG_39782.png'); ?>" class="card-img-top" >
                    <div class="card-body">
                        <h5>Luxury Room</h5>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="public\facilities\wifi.svg" width="80px">
                <h5 class="mt-3">WIFI</h5>
            </div>
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="public\facilities\tv.svg" width="80px">
                <h5 class="mt-3">TELEVISION</h5>
            </div>
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="public\facilities\piano.svg" width="80px">
                <h5 class="mt-3">PIANO</h5>
            </div>
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="public\facilities\book-fill.svg" width="80px">
                <h5 class="mt-3">LIBRARY</h5>
            </div>
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="public\facilities\massage.svg" width="80px">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide bg-white p-4">
                   <div class="profile d-flex align-items-center mb-3">
                    <img src="public\facilities\person.svg " alt="">
